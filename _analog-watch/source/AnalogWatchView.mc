...
module Main {
    ...
    var _complications as Array<ComplicationDrawable> = new Array<ComplicationDrawable>[4];
    var showSeconds as Boolean = true;;
	...
	class AnalogWatchDelegate extends WatchUi.WatchFaceDelegate {
